...
Off-Flathub apps end up with one of these install sources:
  ...
  * manifest - only a flatpak-builder manifest exists, so Flatsea builds it locally
"""
...
from flatsea_core import Manifest, is_open_source, parse_manifest_text
...
log = logging.getLogger("flatsea.crawler.forge")
