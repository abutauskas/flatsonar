...
from flatsonar_core import RiskLevel, RiskReport, metadata_to_finish_args, score_finish_args
...
def _prepare(app: AppInfo, source: InstallSource, api: FlatsonarAPI, status) -> _Prepared:
